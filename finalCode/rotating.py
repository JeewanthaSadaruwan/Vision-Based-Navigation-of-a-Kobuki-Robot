...
def detect_color_boxes(frame, target_color, detected_colors, detected_target, stop_event, horizontal_line_y):
    """
...
def detect_colors(duration, target_color, detected_colors, detected_target, stop_event, horizontal_line_position=0.6):
    """
    ...
    while t.time() - start_time < duration and not stop_event.is_set():
        ...
        processed_frame, target_detected = detect_color_boxes(
            frame, target_color, detected_colors, detected_target, stop_event, horizontal_line_y
        )
...
def run_detection_rotation(kobuki, duration, target_color, horizontal_line_position=0.6):
    ...
    detection_thread = threading.Thread(
        ...
        args=(duration, target_color, detected_colors, detected_target, stop_event, horizontal_line_position)
    )
